...
public class MessageHandler {
    ...
    public void handle(ByteBuffer buffer) {
        ...
        if (message != null) {
            logger.info("Received a message of type " + message.getClass().getSimpleName());
    ...
    protected void handlePubRel(Message message) {
    	...
    	PublishMessage publishMessage = (PublishMessage)context.getMessageStore().getQos2("ONPUBLISH_" + m.getMessageID());
